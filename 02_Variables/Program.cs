...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("-------------------------");
            //Console.WriteLine("Yolcu TC Kimlik No: " + passengerIdentityNumer + " -Yolcu Ad Soyad:"+  passengerName + " " + passengerSurname + " " + passengerDistrict + " / " + passengerCity + " " + passengerAge);
            ...
            //int shoesPrice, computerPrice, chairPrices, tvPrice;
            //shoesPrice = 1000;
            //computerPrice = 20000;
            //chairPrices = 5000;
            //tvPrice = 12000;
            ...
            //int totalPrice= shoesCount*shoesPrice + computerCount*computerPrice + chairPrices*chairCount + tvPrice*tvCount;
